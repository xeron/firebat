class RmudAdditemCommand < FireBatCommand
  ...
  def on_privmsg( cmd )
    if @prop == "Название:"
      ...
      keys = {"Свойства:" => "prop","Тип:" => "tip","Ограничения:" => "lim","Влияния:" => "vli","Эффекты:" => "eff","Содержит заклинание:" => "spell","Заряды:" => "spells","Сила удара:" => "dmg","Качество брони:" => "armor","Содержит:" => "spell","С:" => "S"}
      field = keys[@prop]
      @i[field] = @val
      @i.save
